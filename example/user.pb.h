...
class RegisterResponse :
 ...
 public:
  ...
  ::fixbug::ResultCode* release_resultcode();
...
// .fixbug.ResultCode resultcode = 1;
inline bool RegisterResponse::_internal_has_resultcode() const {
  return this != internal_default_instance() && resultcode_ != nullptr;
}
inline bool RegisterResponse::has_resultcode() const {
  return _internal_has_resultcode();
}
inline void RegisterResponse::clear_resultcode() {
  if (GetArenaNoVirtual() == nullptr && resultcode_ != nullptr) {
    delete resultcode_;
  }
  resultcode_ = nullptr;
}
inline const ::fixbug::ResultCode& RegisterResponse::_internal_resultcode() const {
  const ::fixbug::ResultCode* p = resultcode_;
  return p != nullptr ? *p : *reinterpret_cast<const ::fixbug::ResultCode*>(
      &::fixbug::_ResultCode_default_instance_);
}
inline const ::fixbug::ResultCode& RegisterResponse::resultcode() const {
  // @@protoc_insertion_point(field_get:fixbug.RegisterResponse.resultcode)
  return _internal_resultcode();
}
inline ::fixbug::ResultCode* RegisterResponse::release_resultcode() {
  // @@protoc_insertion_point(field_release:fixbug.RegisterResponse.resultcode)
  
  ::fixbug::ResultCode* temp = resultcode_;
  resultcode_ = nullptr;
  return temp;
}
inline ::fixbug::ResultCode* RegisterResponse::_internal_mutable_resultcode() {
...
inline ::fixbug::ResultCode* RegisterResponse::mutable_resultcode() {
  // @@protoc_insertion_point(field_mutable:fixbug.RegisterResponse.resultcode)
  return _internal_mutable_resultcode();
}
inline void RegisterResponse::set_allocated_resultcode(::fixbug::ResultCode* resultcode) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == nullptr) {
    delete resultcode_;
  }
  ...
  // @@protoc_insertion_point(field_set_allocated:fixbug.RegisterResponse.resultcode)
}
