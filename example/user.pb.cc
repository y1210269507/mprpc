...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_user_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::fixbug::RegisterResponse, resultcode_),
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_user_2eproto = {
  &descriptor_table_user_2eproto_initialized, descriptor_table_protodef_user_2eproto, "user.proto", 464,
...
void RegisterResponse::InitAsDefaultInstance() {
  ::fixbug::_RegisterResponse_default_instance_._instance.get_mutable()->resultcode_ = const_cast< ::fixbug::ResultCode*>(
      ::fixbug::ResultCode::internal_default_instance());
}
class RegisterResponse::_Internal {
 public:
  static const ::fixbug::ResultCode& resultcode(const RegisterResponse* msg);
};

const ::fixbug::ResultCode&
RegisterResponse::_Internal::resultcode(const RegisterResponse* msg) {
...
RegisterResponse::RegisterResponse(const RegisterResponse& from)
  ...
  if (from._internal_has_resultcode()) {
    resultcode_ = new ::fixbug::ResultCode(*from.resultcode_);
  } else {
    resultcode_ = nullptr;
  }
  success_ = from.success_;
...
void RegisterResponse::SharedCtor() {
  ...
  ::memset(&resultcode_, 0, static_cast<size_t>(
      reinterpret_cast<char*>(&success_) -
      reinterpret_cast<char*>(&resultcode_)) + sizeof(success_));
}
...
// @@protoc_insertion_point(class_specific_merge_from_start:fixbug.RegisterResponse)
  ...
  if (from.has_resultcode()) {
    _internal_mutable_resultcode()->::fixbug::ResultCode::MergeFrom(from._internal_resultcode());
  }
  if (from.success() != 0) {
    _internal_set_success(from._internal_success());
  }
