...
const char descriptor_table_protodef_test_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "onse\022O\n\016GetFreindLists\022\035.fixbug.GetFrien"
...
void UserServiceRpc::GetFreindLists(::PROTOBUF_NAMESPACE_ID::RpcController* controller,
                         const ::fixbug::GetFriendListsRequest*,
                         ::fixbug::GetFriendListsResponse*,
                         ::google::protobuf::Closure* done) {
  controller->SetFailed("Method GetFreindLists() not implemented.");
  done->Run();
}
...
void UserServiceRpc_Stub::GetFreindLists(::PROTOBUF_NAMESPACE_ID::RpcController* controller,
